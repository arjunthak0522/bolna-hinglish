(() => {
  ...
  const CONVERSATION_GRAPH={
    ...
    'is there a scheduled power cut?':{scenario:'power',partner:'building-maintenance',phase:'diagnose',owner:'them',next:['When will the water come back?','The backup power is not working.','The generator has not started.'],block:['When will the water come back?']},
    ...
    'we need a water tanker.':{scenario:'water-tanker',partner:'building-maintenance',phase:'arrange-delivery',owner:'them',next:['Please call me before you come.','When does the water supply come?','The water tank is empty.']},

    'there is a leak under the sink.':{scenario:'plumbing',partner:'repair-tech',phase:'report-problem',owner:'them',next:['I need a plumber today.','Can someone come fix this today?','Please check the leak again.']},
    ...
    'please check the leak again.':{scenario:'plumbing',partner:'repair-tech',phase:'recheck',owner:'them',next:['It is still not fixed.','Someone came yesterday but it is still broken.','Please send someone else.']},
    'it is still not fixed.':{scenario:'repair',partner:'repair-tech',phase:'escalate',owner:'them',next:['Someone came yesterday but it is still broken.','Please send someone else.','Please check the leak again.']},
    ...
    'the driver cannot find my building.':{scenario:'driver-location',partner:'driver',phase:'locate',owner:'me',next:['Please come to the main gate.','Please call me when you reach.','Use the other entrance.']},
    'the driver is at the wrong gate.':{scenario:'driver-location',partner:'driver',phase:'redirect',owner:'me',next:['Use the other entrance.','Please come to the main gate.','Please call me when you reach.']},
    'please send me your location.':{scenario:'driver-location',partner:'driver',phase:'locate',owner:'them',next:['Please come to the main gate.','Please call me when you reach.','Please wait here for ten minutes.']},
    'please come to the main gate.':{scenario:'driver-location',partner:'driver',phase:'approach',owner:'them',next:['Please call me when you reach.','Please wait here for ten minutes.','Use the other entrance.']},
    'please wait here for ten minutes.':{scenario:'driver-wait',partner:'driver',phase:'wait',owner:'them',next:['Please call me when you reach.','You do not need to wait.','Please come back at 6 PM.']},

    'the delivery person cannot find the building.':{scenario:'delivery-location',partner:'delivery-person',phase:'locate',owner:'me',next:['Please call me when you arrive.','Please leave the package with security.','Please come to the main gate.']},
    'the delivery person says he is outside.':{scenario:'delivery-arrival',partner:'delivery-person',phase:'arrival',owner:'me',next:['I will come downstairs in two minutes.','Please leave the package with security.','The delivery person can come up.']},
    'my package says delivered but i do not have it.':{scenario:'missing-package',partner:'delivery-support',phase:'investigate',owner:'them',next:['Ask them to call me.','Please call me when they arrive.','Please leave the package with security.']},
    ...
    'please let my guest in.':{scenario:'guest-entry',partner:'security',phase:'arrival',owner:'them',next:['Please call me when my guest arrives.','Please send them up.','Please do not send them up yet.']},
    ...
    'can you deliver this medicine tonight?':{scenario:'pharmacy-delivery',partner:'pharmacist',phase:'delivery',owner:'them',next:['Please call me if you find this medicine.','When will this medicine be available?','Can you call another pharmacy?']},

    'please make it less spicy.':{scenario:'restaurant-order',partner:'restaurant-staff',phase:'customize',owner:'them',next:['Please pack this separately.','Can you make this fresh?','This is not what I ordered.']},
    'something is missing from my order.':{scenario:'restaurant-complaint',partner:'restaurant-staff',phase:'complaint',owner:'them',next:['This is not what I ordered.','Something is missing from my order.','Can you make this fresh?'],block:['Please pack this separately.']},
    'this is not what i ordered.':{scenario:'restaurant-complaint',partner:'restaurant-staff',phase:'complaint',owner:'them',next:['Something is missing from my order.','Can you make this fresh?','Please pack this separately.']},

    'please come later today.':{scenario:'housekeeper-schedule',partner:'housekeeper',phase:'reschedule',owner:'them',next:['Please come tomorrow instead.','Please leave the key with security.','Please call me before you come.']},
    'please come tomorrow instead.':{scenario:'housekeeper-schedule',partner:'housekeeper',phase:'reschedule',owner:'them',next:['Please call me before you come.','Please leave the key with security.','Please come later today.']},
    'please clean this again.':{scenario:'housekeeper-task',partner:'housekeeper',phase:'task',owner:'them',next:['Please change the bedsheets.','Please take the trash out.','Please leave the key with security.']},
