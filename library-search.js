(function(root,factory){
  ...
  const aliasGroups=[
    ...
    ['guard','security','watchman','reception','front desk'],
    ...
    ['delivery','package','parcel','courier','rider','delivery person'],
    ['quick commerce','blinkit','zepto','instamart','swiggy instamart','bigbasket','grocery app','delivery app'],
    ['missing','not received','left out','incomplete','short order'],
    ['wrong','incorrect','different','not what ordered'],
    ['refund','money back','return payment','reverse payment'],
    ['replace','replacement','exchange'],
    ['substitute','substitution','alternative','alternate','another brand'],
    ['damaged','broken','torn','leaking','open packet','seal broken'],
    ['expired','expiry','past date','out of date'],
    ['fresh','quality','good','stale','spoiled','rotten','bad quality'],
    ['charged twice','double charged','duplicate charge','charged two times'],
    ['support','customer care','help','agent'],
    ['complaint','reported','report','issue','problem'],
    ['gate','entrance'],
